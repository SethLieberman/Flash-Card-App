...
Profile.create([
	...
	{fname: "jim", lname: "halpert", credibility: 400, level: 4, username: "user2", user_id: 2},
	{fname: "bob", lname: "from account", credibility: 500, level: 5, username: "user3", user_id: 3},
	{fname: "tom", lname: "hanks", credibility: 600, level: 6, username: "user4", user_id: 4},
	{fname: "tina", lname: "superuser", credibility: 1200, level: 12, username: "user5", user_id: 5}
	])
